...
Wajib menggunakan rekursif untuk berlatih rekursif! Disarankan untuk tidak
menggunakan looping for untuk soal ini.

Contoh:

512, berarti outputnya adalah 8, karena 5 + 1 + 2 = 8. 1542, berarti outputnya
adalah 12, karena 1 + 5 + 4 + 2 = 12.
*/
...
function totalDigitRekursif(angka) {
  if (angka < 10) {
    ...
    return mod + totalDigitRekursif(hasil);
  }
}
